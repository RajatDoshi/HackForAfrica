...
userDatabase = firebase.FirebaseApplication('https://tellus.firebaseio.com/userInfo')
doctorInfoDatabase = firebase.FirebaseApplication('https://tellus.firebaseio.com/doctorInfo')
doctorPortalDatabase = firebase.FirebaseApplication('https://tellus.firebaseio.com/doctorPortal')
doctorChat = firebase.FirebaseApplication('https://tellus.firebaseio.com/doctorChat')
diagnosisTableData = firebase.FirebaseApplication('https://tellus.firebaseio.com/diagnosisTableData')
storeUserApptReqDatabase = firebase.FirebaseApplication('https://tellus.firebaseio.com/storeUserApptReq')
docSchedDatabase = firebase.FirebaseApplication('https://tellus.firebaseio.com/storeCalendarDataTable')
storeCalendarDatabaseU = firebase.FirebaseApplication('https://tellus.firebaseio.com/storeCalendarDataTableUser')
storeAptDateFinal = firebase.FirebaseApplication('https://tellus.firebaseio.com/storeAptDateFinal')
